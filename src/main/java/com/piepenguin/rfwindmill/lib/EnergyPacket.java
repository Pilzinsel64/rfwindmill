...
/**
 * <p>
 * Energy production is handled by producing energy packets, which have a total
 ...
 * generation can be handled by a single system.
 * </p>
 *
 * <p>
 * Machines should not accept new energy packets until they have dealt with
 ...
 *
 * <p>
 * Assuming a machine takes a single packet as described above the packet
 * length can be used to lessen the load on the server, as the external energy
 * production only has to be calculated after a packet has been depleted.
 * </p>
 */
