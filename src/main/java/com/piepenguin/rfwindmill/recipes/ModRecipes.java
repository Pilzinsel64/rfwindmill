...
public class ModRecipes {
    ...
    private static void registerVanillaTurbines() {
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ModBlocks.windmillBlock, 1, 0),
                " x ",
                "ibi",
                "ixi",
                'x',
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ModBlocks.windmillBlock, 1, 1),
                " x ",
                "ibi",
                "ixi",
                'x',
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ModBlocks.windmillBlock, 1, 2),
                " x ",
                "ibi",
                "oxo",
                'x',
        ...
        GameRegistry.addRecipe(
            new ShapedOreRecipe(
                new ItemStack(ModBlocks.windmillBlock, 1, 3),
                " x ",
                "dbd",
                "ixi",
                'x',
    ...
    private static void registerVanillaRotors() {
        GameRegistry
            .addRecipe(new ShapedOreRecipe(ModItems.rotor2, "g  ", "gig", "  g", 'i', "ingotIron", 'g', "ingotGold"));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(ModItems.rotor3, "n  ", "non", "  n", 'n', Items.quartz, 'o', Blocks.obsidian));
        GameRegistry
            .addRecipe(new ShapedOreRecipe(ModItems.rotor4, "d  ", "dgd", "  d", 'd', "gemDiamond", 'g', "ingotGold"));
    }
    ...
    private static void registerThermalFoundationRotors() {
        GameRegistry.addRecipe(
            new ShapedOreRecipe(ModItems.rotor2, "e  ", "eie", "  e", 'i', "ingotInvar", 'e', "ingotElectrum"));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(ModItems.rotor3, "s  ", "ses", "  s", 's', "ingotSignalum", 'e', "ingotElectrum"));
        GameRegistry.addRecipe(
            new ShapedOreRecipe(ModItems.rotor4, "e  ", "eie", "  e", 'e', "ingotEnderium", 'i', "ingotInvar"));
    }
    ...
    private static void registerThermalExpansionTurbines() {
        ItemStack powerCoilSilver = Preconditions
            .checkNotNull(GameRegistry.findItemStack(Constants.THERMAL_EXPANSION_MOD_ID, "powerCoilSilver", 1));
        ItemStack machineFrameBasic = Preconditions
            .checkNotNull(GameRegistry.findItemStack(Constants.THERMAL_EXPANSION_MOD_ID, "frameMachineBasic", 1));
        ItemStack machineFrameHardened = Preconditions
            .checkNotNull(GameRegistry.findItemStack(Constants.THERMAL_EXPANSION_MOD_ID, "frameMachineHardened", 1));
        ItemStack machineFrameReinforced = Preconditions
            .checkNotNull(GameRegistry.findItemStack(Constants.THERMAL_EXPANSION_MOD_ID, "frameMachineReinforced", 1));
        ItemStack machineFrameResonant = Preconditions
            .checkNotNull(GameRegistry.findItemStack(Constants.THERMAL_EXPANSION_MOD_ID, "frameMachineResonant", 1));
        ItemStack hardenedGlass = Preconditions
            .checkNotNull(GameRegistry.findItemStack(Constants.THERMAL_EXPANSION_MOD_ID, "Glass", 1));
